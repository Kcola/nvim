...
local search_vim_config = function()
	require("telescope.builtin").find_files({
		prompt_title = "<VimRc >",
		cwd = IS_WINDOWS and "C:\\Users\\kolacampbell\\dotfiles\\.config\\" or "~/.config",
		path_display = { "truncate" },
	})
end
...
vim.keymap.set("n", "<c-b>", require("telescope.builtin").find_files, { desc = "[S]earch [F]iles" })
...
vim.keymap.set("n", "<c-p>", require("telescope.builtin").buffers, { desc = "[S]earch [B]uffers" })
